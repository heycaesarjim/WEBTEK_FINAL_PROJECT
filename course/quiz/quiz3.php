...
<li>
	...
	<div>
		...
		<label for="question-1-answers-A">A) Express.js </label>
	</div>
	<div>
		<input type="radio" name="question-1-answers" id="question-1-answers-B" value="B" />
		<label for="question-1-answers-B">B) AngularJS </label>
	</div>
	<div>
		<input type="radio" name="question-1-answers" id="question-1-answers-C" value="C" />
		<label for="question-1-answers-C">C) MongoDB </label>
	</div>
</li>
<!-- Question 2 -->
<li>
	...
	<div>
		...
		<label for="question-2-answers-A">A) Express.js </label>
	</div>
	<div>
		<input type="radio" name="question-2-answers" id="question-2-answers-B" value="B" />
		<label for="question-2-answers-B">B) AngularJS </label>
	</div>
	<div>
		<input type="radio" name="question-2-answers" id="question-2-answers-C" value="C" />
		<label for="question-2-answers-C">C) MongoDB </label>
	</div>
</li>
<!-- Question 3 -->
<li>
	...
	<div>
		...
		<label for="question-3-answers-A">A) Express.js </label>
	</div>
	<div>
		<input type="radio" name="question-3-answers" id="question-3-answers-B" value="B" />
		<label for="question-3-answers-B">B) AngularJS  </label>
	</div>
	<div>
		<input type="radio" name="question-3-answers" id="question-3-answers-C" value="C" />
		<label for="question-3-answers-C">C) MongoDB </label>
	</div>
</li>
<!-- Question 4 -->
<li>
	...
	<div>
		...
		<label for="question-4-answers-A">A) Express.js </label>
	</div>
	<div>
		<input type="radio" name="question-4-answers" id="question-4-answers-B" value="B" />
		<label for="question-4-answers-B">B) NodeJS </label>
	</div>
	<div>
		<input type="radio" name="question-4-answers" id="question-4-answers-C" value="C" />
		<label for="question-4-answers-C">C) MongoDB </label>
	</div>
</li>
<!-- Question 5 -->
<li>
	...
	<div>
		...
		<label for="question-5-answers-A">A) NodeJS </label>
	</div>
	<div>
		<input type="radio" name="question-5-answers" id="question-5-answers-B" value="B" />
		<label for="question-5-answers-B">B) AngularJS  </label>
	</div>
	<div>
		<input type="radio" name="question-5-answers" id="question-5-answers-C" value="C" />
		<label for="question-5-answers-C">C) MongoDB </label>
	</div>
</li>
<!-- Question 6 -->
<li>
	...
	<div>
		...
		<label for="question-6-answers-A">A) RIGHT STACK </label>
	</div>
	<div>
		<input type="radio" name="question-6-answers" id="question-6-answers-B" value="B" />
		<label for="question-6-answers-B">B) MEAN STACK </label>
	</div>
	<div>
		<input type="radio" name="question-6-answers" id="question-6-answers-C" value="C" />
		<label for="question-6-answers-C">C) HEADER STACK </label>
	</div>
</li>
<!-- Question 7 -->
<li>
...
<li>
	...
	<div>
		...
		<label for="question-16-answers-A">A) Command Line Interface </label>
	</div>
	<div>
		<input type="radio" name="question-16-answers" id="question-16-answers-B" value="B" />
		<label for="question-16-answers-B">B) Netbeans </label>
	</div>
	<div>
		<input type="radio" name="question-17-answers" id="question-17-answers-C" value="C" />
		<label for="question-17-answers-C">C) VirtualBox </label>
	</div>
</li>
<!-- Question 17 -->
<li>
	...
	<div>
		...
		<label for="question-17-answers-A">A) Express.js </label>
	</div>
	<div>
		<input type="radio" name="question-17-answers" id="question-17-answers-B" value="B" />
		<label for="question-17-answers-B">B) Node.js </label>
	</div>
	<div>
		<input type="radio" name="question-17-answers" id="question-17-answers-C" value="C" />
		<label for="question-17-answers-C">C) AngularJS </label>
	</div>
</li>
<!-- Question 18 -->
<li>
...
<li>
	...
	<div>
		...
		<label for="question-20-answers-A">A) fs.readFile() </label>
	</div>
	<div>
		<input type="radio" name="question-20-answers" id="question-20-answers-B" value="B" />
		<label for="question-20-answers-B">B) js.readFile() </label>
	</div>
	<div>
		<input type="radio" name="question-20-answers" id="question-20-answers-C" value="C" />
		<label for="question-20-answers-C">C) rs.readFile() </label>
	</div>
</li>
